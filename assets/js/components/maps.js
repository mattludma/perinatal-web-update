...
if ($('#all-maps-maternity').length) {
  ...
  let markers = [
    ...
    },
    {
      ...
      link:
        'http://www.nemnbk.cz/oddeleni/luzkova-pece/gynekologicko-porodnicke-oddeleni-porodnice/',
    },
    {
